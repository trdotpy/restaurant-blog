          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                <h2 className="text-2xl font-bold text-white">
                  Stay up to date with the latest food news!
                </h2>
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full text-white">
                ...
                <div className="border border-white/10 p-2 sm:flex sm:items-center">
                  ...
                  <button
                    className="mt-1 h-12 w-full bg-[#A51C30] px-6 py-3 text-sm font-semibold uppercase tracking-wide sm:ml-4 sm:mt-0 sm:w-auto sm:flex-shrink-0"
                    type="submit"
                  >
                    Sign Up
                  </button>
            ...
            <div className="col-span-2 flex gap-4 text-gray-500 lg:col-span-5">
              ...
              >
                {/* Github */}
                <svg
                  className="h-6 w-6 text-[#A51C30] hover:text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
